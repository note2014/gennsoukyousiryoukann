...
echo [20] 東方憑依華
echo [21] 東方天空璋
echo [22] 秘封ナイトメアダイアリー
echo [23] 東方鬼形獣
echo [24] 東方虹龍洞
echo [25] 東方剛欲異聞
echo [26] バレットフィリア達の闇市場
echo [27] 東方獣王園
echo [28] 東方錦上京
echo [c] commandroom
echo [n] 東方年表
...
if "%x%"=="15" goto sinnki
if "%x%"=="16" goto kisinn
if "%x%"=="17" goto dannmaku
if "%x%"=="18" goto sinnpi
if "%x%"=="19" goto kannzyu
if "%x%"=="20" goto hyoui
if "%x%"=="21" goto tennku
if "%x%"=="22" goto hihuu
if "%x%"=="23" goto kikei
if "%x%"=="24" goto kouryu
if "%x%"=="25" goto gouyoku
if "%x%"=="26" goto baretto
if "%x%"=="27" goto zyuuou
if "%x%"=="28" goto kinnzyou
if "%x%"=="c" goto command
if "%x%"=="m" goto myu-zikkuru-mu
if "%x%"=="s" goto seiti
if "%x%"=="r" goto ninnki
if "%x%"=="k" goto kure
if "%x%"=="0" goto end
...
echo 平成17年2005 年 東方花映塚 東方文花帖
echo 平成19年2007 年 東方風神録  
...
if "%cmd%"=="1341398" goto sakuya
if "%cmd%"=="8901016" goto reimu
if "%cmd%"=="9" goto tiruno
if "%cmd%"=="514" goto koisi
if "%cmd%"=="495" goto hurann
if "%cmd%"=="500" goto remiria
if "%cmd%"=="2002" goto kouma
if "%cmd%"=="2003" goto youmu
if "%cmd%"=="2004" goto eiya&suimu
if "%cmd%"=="end" goto END
if "%cmd%"=="no" goto MENU
:sakuya
cls
...
echo   諏訪大社
echo ==============
echo 風神録関係のが多いです。神奈子さんがスペルカードうつときの背景が諏訪大社下社秋宮の神楽殿になっている。
echo 諏訪大社上社前宮では東方風神録のCDジャケットにある御柱がある。
echo その御柱の近くには小川が流れていて、それが神奈子さんのスペルカードの元ネタになっている。
echo それが、神符「水眼の如き美しき源泉」などがある。
pause
goto itirann
:zenn
cls
...
echo    善光寺
echo ==============
echo 善光寺は伊弉諾物質（いざなぎぶっしつ）という音楽CDのの中で秘封倶楽部の2人が訪れた場所
pause
goto itirann
:mori
cls
...
echo      洩矢神社
echo =====================
echo 幻想郷の守矢神社とは漢字は違うけど読み方は一緒。諏訪子ゆかりの地です。神社に東方グッズを置いて行ったり。
echo 絵馬にキャラクターの絵をかいたりしてあります。
echo 洩矢神という洩矢諏訪子さんのルーツになった神様がまつられています。
pause
goto itirann
:siro
cls
...
echo      城嶺神社
echo ====================
echo ここは博麗神社の元ネタとかと言われています。理由はまず立地です。博麗神社は山のふもとにあり城嶺神社も山のふもとにある。
echo そして城嶺神社も博麗神社も地震でぶっ壊れてる城嶺神社は2014年の秋に地震があり倒壊していて、
echo 博麗神社は東方緋想天でぶっ壊れている。
echo あとは城嶺神社（じょうみねじんじゃ）をしろみねじんじゃに漢字変換するとこう白嶺神社そして読み方変えると？
echo はくれいじんじゃになる。
pause
goto itirann
:kuma
...
echo    五方山 熊野神社
echo ========================
echo ここの神社のマークは地霊殿のステンドグラスにあるマークにめちゃくちゃ似ている。
echo そのこともあり東方と五方山 熊野神社はコラボして、東方のお守りや絵馬があります。
pause
goto itirann
:matu
cls
...
echo        松本城
echo ====================== 
echo 松本城の外見は輝針城に似てるといわれてるらしく、水に写って逆さになると輝針城みたいになるらしい。
pause
goto itirann
...
echo 幻想郷資料館
echo 製作者 きくっち
echo 製作日 1.1 2026年令和8年 5月10日 1.2 2026年令和8年 5月22日 1.3　2026年令和8年　5月30日 1.4　2026年令和8年6月4日 1.5　2026年令和8年6月28日
